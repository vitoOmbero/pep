...
void VisualScenes::Logic::intro_level::Transition() {pep::EnableInputMode(0);}
...
static void RotateLevelLoading(size_t current_level_id, int step) {
  ...
  auto new_id = (current_level_id + step) %
                (VisualScenes::Logic::visual_scenes.size());
  auto target =
      (new_id > 0 & new_id < VisualScenes::Logic::LAST_LEVEL) ? new_id : 1;
...
void VisualScenes::Logic::texture_level::OnLoad() {
  pep::LoadTextWorldObjectById(0);
}
void VisualScenes::Logic::texture_level::ExecuteTextWorldLogic() {}
void VisualScenes::Logic::texture_level::Transition() {}

void VisualScenes::Logic::sprite_level::OnLoad() {
  pep::LoadTextWorldObjectById(0);
}
void VisualScenes::Logic::sprite_level::ExecuteTextWorldLogic() {}
void VisualScenes::Logic::sprite_level::Transition() {}
