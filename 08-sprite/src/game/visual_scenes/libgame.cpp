...
PEP_DECLSPEC const TexturePackMap* game::getTexturePacks() {
  return &VisualScenes::Assets::game_assets_texture_packs;
}

PEP_DECLSPEC const std::vector<SpriteMultiImage>* game::getSpriteMultiImages() {
  return &VisualScenes::Assets::game_sprite_multi_images;
}
