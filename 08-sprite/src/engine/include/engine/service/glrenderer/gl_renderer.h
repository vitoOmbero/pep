...
class GlRenderer {
 ...
 private:
  ...
  std::map<GLuint,std::chrono::milliseconds> i_sprite_target_frame_time_;
  std::map<GLuint,size_t> i_sprite_target_frame_index_;
  ...
  void LoadSprite(const visual_world_objects::Type& vwo);
