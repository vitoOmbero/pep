...
/*!
 * NOTE: Current realization just demonstrates an idea, there are no real work with unicode and no correct layout
 */
class Terminal {
public:
    static void Init() {
    ...
    static void ReportVal(std::string_view msg, size_t val, std::string_view msg2);

    static void
    InputValue(std::string_view msg_tip, std::string_view msg_fail, size_t &val_storage, size_t min, size_t max);
